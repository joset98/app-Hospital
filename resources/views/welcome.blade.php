...
<!-- landing-page sidebar-collapse de acuerdo al cuerpo de la correspondiente pagina-->
@section('title','Clinica la Esperanza')

@section('content')

<div class="page-header header-filter" data-parallax="true" style="background-image: url( {{ asset('/img/bg.jpg') }} ); background-size: cover; background-position: top center;">
    <div class="container">
    <div class="row">
        <div class="col-md-6">
